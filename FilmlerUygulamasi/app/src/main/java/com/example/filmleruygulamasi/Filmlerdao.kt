...
class Filmlerdao {
    ...
    fun tumFilmlerbyKategoriId(vt:VeritabaniYardimcisi, kategori_id:Int):ArrayList<Filmler>{
        ...
        val c = db.rawQuery("SELECT * FROM kategoriler,yonetmenler,filmler WHERE filmler.kategori_id = kategoriler.kategori_id " +
        ...
        while (c.moveToNext()){
            ...
            val film = Filmler(c.getInt(c.getColumnIndex("film_id"))
                ...
                ,c.getString(c.getColumnIndex("film_resim")),yonetmen,kategori)
